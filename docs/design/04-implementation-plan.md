...
- **Remaining M5 arcs:** WebCodecs compositor + multi-track/gapless playback (incl. audio mixing), ripple trim, take-aware shot-clip source binding (image takes, blade offsets).
