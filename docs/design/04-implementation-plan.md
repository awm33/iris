...
- **PR 36 — color basics:** per-clip exposure/contrast/temp (+ LUT), one op vocabulary addition; preview shader in the compositor with a matching ffmpeg filter at export.
