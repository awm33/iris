...
- **PR 35 — transcribe → caption track:** local whisper-class model in the media worker (no real remotes), caption data + timeline caption editing, SRT sidecar + export burn-in.
